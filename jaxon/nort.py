...
def model(
        ...
        dilution_factor=1, scattering_phase_func='henyey-greenstein',
        pointwise=False,
        **kwargs
):
    """
    ...
    reflected_ppm_grid, A_g = reflected_phase_curve(
        ...
        scattering_phase_func=scattering_phase_func
    )
...
def get_model_kwargs(
        planet_name, scattering_phase_func='henyey-greenstein',
        quarter=None
    ):
...
def run_mcmc(
        planet_name, scattering_phase_func='henyey-greenstein',
        run_title='tmp', num_warmup=5, num_samples=10, quarter=10
):
    """
    ...
    arviz_mcmc.to_netcdf('chains_' + planet_name + '_' + run_title + '.nc')
